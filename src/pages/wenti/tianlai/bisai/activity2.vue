  ...
  <div class="container-fluid">
    <div class="pb_tag_top">
      <span><a href="javascript:history.go(-1)" class="back"><img src="@/assets/images/arrow-lift.png"></a></span>
        天籁之音
        <div class="bisaishow">
          <span @click.stop.prevent="bisai_show = !bisai_show ">展示类<img src="@/assets/images/xiajiantous.png"></span>
        </div>
    ...
    <div class="bisai_nr">
      <van-popup v-model="bisai_show" position="top" >
          <div class="bisai_select">
            <ul>
              <li v-for="(item,index) in nva_top"  :key="index" @click.stop.prevent="dianji_router(item)">
                <div class="">
                  <span>{{item.name}}</span>
        ...
        <van-tab title="参赛作品">
          ...
          <div class="m_pubuniu">
            <div class="container-water-fall container">
              ...
              <!-- <div  v-if="this.anniubtn==1"   class="container-fluid dibu_scsppp">
                <div class="m_p_d_s">
                  ...
                  <div class="baom_up_nr  shangchuanner">
                    ...
                    <div class="videoupd">
                      ...
                      <div class="upload-img">
                          <van-uploader v-model="fileList.config" multiple accept="image/gif, image/jpeg,video/*"  :after-read="afterRead" :before-delete="beforeDelete" />
                       </div>
                  ...
                  <swiper :options="sw_vd_img" class="sw_vd_img">
                    <swiper-slide v-for="(item,index) in tan_images"  :key="index">
                      <div  v-if="item.type=='video'"   class="m_vdsp_all" >
                        <video  controls autoplay :src="item.path">
                        </video>
...
export default {
  ...
  methods: {
    ...
    get_zuopin(){
      ...
      this.axios.post(url+'/'+urlsolw.company+'/'+urlsolw.page_sign+'2',qs.stringify({params:parm}),)
      .then((res) => {
        console.log("瀑布流？？？？？");
    ...
    big_img(post_id,index){
      ...
      // return
        ...
        console.log(this.pubu_data[index]);
    ...
    get_all_data(){
      ...
      let url = this.api.userApi.get_activity_details
       this.axios.post(url+'/'+param.company+'/'+'activity_details'+'2',qs.stringify(param),)
      .then((res) => {
